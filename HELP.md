...
- The original package name `com.miche-let.user-service` is invalid and this project uses `com.miche_let.user_service` instead.
...
- [Eureka Discovery Client](https://docs.spring.io/spring-cloud-netflix/reference/spring-cloud-netflix.html#service-discovery-eureka-clients)
